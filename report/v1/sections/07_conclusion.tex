...
Turning the question around, the noise parameters of the two conditional distributions could be estimated from a
recorded run by the same weights the filter already forms. The measurement parameters were recovered to within one
step of the sweep, 0.19\,m against a true 0.2\,m and 0.047\,rad against a true 0.05\,rad, and independent
recordings agreed on them. The motion parameters were not determined by 30 steps of this world at all, and became
determined on 400 steps, so identifiability is a property of the data rather than of the method. Learning also
proved to rest on the inference: from a uniform start, or with too few particles, the likelihood does not point
at the values that generated the data.
